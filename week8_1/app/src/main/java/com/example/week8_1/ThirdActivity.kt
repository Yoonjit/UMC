...
import com.example.week8_1.databinding.ActivityThirdBinding
import com.example.week8_1.db.AppDatabase
import com.example.week8_1.db.MemoDao
import com.example.week8_1.db.MemoEntity

class ThirdActivity : AppCompatActivity(), OnItemLongClickListener {
    ...
    private fun getStarMemoList(){
        Thread{
            memoList = ArrayList(memoDao.getStar())
            setRecyclerView()
        }.start()
    }
